...
> **Примечание**: Для добавления реальных скриншотов создайте папку `screenshots/` в корне проекта и поместите туда изображения с соответствующими именами.
...
Приложение готово к использованию и может быть легко расширено дополнительным функционалом, таким как:
...
Этот проект создан в учебных целях для контрольной работы.

## 👤 Автор

Студент курса по React разработке
